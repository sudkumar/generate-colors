const checkColorCompliant = require('./checkColorCompliant')
const getContrastRatio = require('./getContrastRatio')
/**
...
function checkAccessibility ([r1, g1, b1], [r2, g2, b2]) {
  ...
  return {
    ...
    w2aaab,
    w2aaaa,
    warn: !colorCompliant || !contrastRatio || !w2b || !w2a || !w2aaab || !w2aaaa
  }
}
